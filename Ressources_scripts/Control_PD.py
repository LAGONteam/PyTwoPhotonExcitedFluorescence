...
try:
    ...
    print(path_python_wrapper)
    import Ressources_scripts.TLPM as TLPM
    #import TLPM
    ...
    def error_management(func):
        ...
        def wrapper(*args, **kwargs):
            try:
                ...
                print(f'The function {func.__name__} returned the error: {e}')
                return default_arg
        return wrapper
...
if __name__ == '__main__':
    ...
    with CustomTLPM(0) as tlpm:
        print(tlpm.infos.get_devices_info)
        tlpm.wavelength=800
        b = tlpm.wavelength
        print(b)
        a=tlpm.get_power()
